...
**本项目现已暂时停更**，开发者由于很多不可抗力因素，最终决定暂时停更此项目。

这段时间做出的努力大部分开源，小部分由于使用/借鉴了其他私密仓库，故不开源
...
长话短说，首先感谢各位用户的支持与信任。这个项目对我意义非常重大，从2025年3月开始编写到2026年8月5日暂时停更期间不断维护着。这期间由于手机被神秘力量影响 + 自身生活问题中断更新过几次。

2025年2月下旬，番茄更新了鉴权算法。开发者由于手里只有未root的手机，没有电脑，并且由于自身编程能力有限，在此期间率先尝试了unidbg，但由于设备与技术问题频繁碰壁，在6月下旬决定转攻纯算也接连碰壁，最终导致项目暂时停更。

所以选择暂时停更，但仍然不会删库跑路，只需等待。
...
~[支持音效的命令行网易云播放器](https://github.com/Dlmily/music-fx-player)
